// http://laichuanfeng.com/work/carousel-in-react/
        ...
        return (
            <div className='content'>
                <ul className='carousel'>
                    {
                        Carousel.imgs.map((img, index) => <li key={index} className={this.getClassName(index)}
                                                              style={{ background: `url(${Carousel.url}${img})` }}></li>)
                    }
                </ul>
            </div>
        )
